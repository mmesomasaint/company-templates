    ...
    <div>
      ...
      <main>
        <div className='max-w-[90rem] mx-auto'>
          ...
          <div className='h-[15rem] sm:h-[10rem] md:h-[15rem] relative'>
            <div className='absolute h-fit -top-[7rem] md:-top-[15rem] lg:-top-[12rem] left-0 right-0 mx-8 lg:mx-16 bg-white'>
              <div className='w-full h-full grid grid-cols-2 sm:grid-cols-4 grid-rows-4 sm:grid-rows-2 gap-0 md:gap-6 place-items-stretch p-0 md:p-5'>
                ...
                <div className='text-center p-5'>
                  <div className='w-8 h-8 sm:w-12 sm:h-12 md:w-20 md:h-20 mx-auto bg-[#CEF2EF] rounded-full flex justify-center items-center'>
                    <AiOutlineEnvironment className='text-[#76A6A6] text-lg sm:text-2xl md:text-4xl leading-none' />
                  </div>
                  <h2 className='block text-xs sm:text-base md:text-xl font-bold leading-none text-black mt-2 sm:mt-5 capitalize'>
                    Free Pickup
                  </h2>
                ...
                <div className='text-center p-5'>
                  <div className='w-8 h-8 sm:w-12 sm:h-12 md:w-20 md:h-20 mx-auto bg-[#CEF2EF] rounded-full flex justify-center items-center'>
                    <MdOutlineDeliveryDining className='text-[#76A6A6] text-lg sm:text-2xl md:text-4xl leading-none' />
                  </div>
                  <h2 className='block text-xs sm:text-base md:text-xl font-bold leading-none text-black mt-2 sm:mt-5 capitalize'>
                    Free Delivery
                  </h2>
