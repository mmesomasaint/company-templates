    ...
    <div>
      ...
      <main>
        <div className='max-w-[90rem] mx-auto'>
            ...
            <div className='w-full h-full'>
              <div className='w-full mx-auto bg-transparent h-full pt-24 sm:pt-32 pb-40 md:pb-0 px-8 xl:px-16 grid grid-cols-1 md:grid-cols-2 place-items-stretch gap-6 lg:gap-0'>
                ...
                <div className='flex justify-center items-start'>
                  <Image
                    src='/imgs/local-laundry/service-man.png'
                    width={350}
                    height={350}
                    alt='showcase image'
          ...
          <div className='py-16 md:pb-0 px-4 sm:px-8 xl:px-16'>
            <div className='grid grid-cols-1 md:grid-cols-4 xl:grid-cols-3 gap-8 items-center'>
              <div className='hidden md:block col-span-2'>
                <div>
                  <Image
                    src='/imgs/local-laundry/dry-cleaning.jpg'
                    width={1000}
                    height={1000}
                    alt='dry cleaning'
                  />
              ...
              <div className='col-span-2 xl:col-span-1'>
                <div className='flex justify-start items-center gap-2 sm:gap-5'>
                  <div className='w-8 h-8 sm:w-12 sm:h-12 bg-[#CEF2EF] rounded-full flex justify-center items-center'>
                    <MdOutlineDryCleaning className='text-[#76A6A6] text-lg sm:text-2xl md:text-4xl leading-none' />
                  </div>
                  <h2 className='text-2xl sm:text-4xl xl:text-5xl font-extrabold leading-none text-black capitalize'>
                    Dry Cleaning
                  </h2>
                </div>
                ...
                <div className='md:p-5'>
                  <p className='text-sm xl:text-lg font-medium text-black leading-snug'>
                    odio non fringilla. Fusce facilisis magna at odio ultricies,
                    non porta quam scelerisque. Phasellus feugiat odio eget quam
                    mollis dapibusodio non fringilla.
                  </p>
                  <div className='flex flex-col my-4 gap-2'>
                    <div className='flex gap-3 justify-start items-start'>
                      <AiOutlinePushpin className='text-xl xl:text-3xl text-[#D97941] flex-shrink-0' />
                      <p className='text-sm xl:text-lg font-medium text-black'>
                        Nam bibendum tellus pulvina
                      </p>
                    </div>
                    <div className='flex gap-3 justify-start items-start'>
                      <AiOutlinePushpin className='text-xl xl:text-3xl text-[#D97941] flex-shrink-0' />
                  ...
                  <button className='text-base font-medium leading-none text-white px-6 py-3 bg-[#76A6A6] my-1'>
                    Request Service
                  </button>
                </div>
              </div>
          ...
          <div className='pb-16 md:py-0 px-4 sm:px-8 xl:px-16'>
            <div className='grid grid-cols-1 md:grid-cols-4 xl:grid-cols-3 gap-8 items-center'>
              <div className='col-span-2 xl:col-span-1'>
                <div className='flex justify-start items-center gap-2 sm:gap-5'>
                  <div className='w-8 h-8 sm:w-12 sm:h-12 bg-[#CEF2EF] rounded-full flex justify-center items-center'>
                    <GiDrippingStone className='text-[#76A6A6] text-lg sm:text-2xl md:text-4xl leading-none' />
                  </div>
                  <h2 className='text-2xl sm:text-4xl xl:text-5xl font-extrabold leading-none text-black capitalize'>
                    Wet Cleaning
                  </h2>
                ...
                <div className='flex md:hidden justify-center items-center my-4'>
                  <Image
                    src='/imgs/local-laundry/wet-cleaning.jpg'
                    width={1000}
                    height={1000}
                    alt='wet cleaning'
                  />
          ...
          <div className='pb-16 md:pb-0 px-4 sm:px-8 xl:px-16'>
            <div className='grid grid-cols-1 md:grid-cols-4 xl:grid-cols-3 gap-8 items-center'>
              <div className='hidden md:block col-span-2'>
                <div>
                  <Image
                    src='/imgs/local-laundry/laundry.jpg'
                    width={1000}
                    height={1000}
                    alt='laundry'
                  />
              ...
              <div className='col-span-2 xl:col-span-1'>
                <div className='flex justify-start items-center gap-2 sm:gap-5'>
                  <div className='w-8 h-8 sm:w-12 sm:h-12 bg-[#CEF2EF] rounded-full flex justify-center items-center'>
                    <MdOutlineLocalLaundryService className='text-[#76A6A6] text-lg sm:text-2xl md:text-4xl leading-none' />
                  </div>
                  <h2 className='text-2xl sm:text-4xl xl:text-5xl font-extrabold leading-none text-black capitalize'>
                    Laundry
                  </h2>
          ...
          <div className='pb-16 md:pb-0 px-4 sm:px-8 xl:px-16'>
            <div className='grid grid-cols-1 md:grid-cols-4 xl:grid-cols-3 gap-8 items-center'>
              <div className='col-span-2 xl:col-span-1'>
                <div className='flex justify-start items-center gap-2 sm:gap-5'>
                  <div className='w-8 h-8 sm:w-12 sm:h-12 bg-[#CEF2EF] rounded-full flex justify-center items-center'>
                    <MdOutlineIron className='text-[#76A6A6] text-lg sm:text-2xl md:text-4xl leading-none' />
                  </div>
                  <h2 className='text-2xl sm:text-4xl xl:text-5xl font-extrabold leading-none text-black capitalize'>
                    Iron Clothes
                  </h2>
                ...
                <div className='flex md:hidden justify-center items-center my-4'>
                  <Image
                    src='/imgs/local-laundry/ironing.jpg'
                    width={1000}
                    height={1000}
                    alt='ironing'
                  />
          ...
          <div className='pb-16 md:pb-0 px-4 sm:px-8 xl:px-16'>
            <div className='grid grid-cols-1 md:grid-cols-4 xl:grid-cols-3 gap-8 items-center'>
              <div className='hidden md:block col-span-2'>
                <div>
                  <Image
                    src='/imgs/local-laundry/wash-fold.jpg'
                    width={1000}
                    height={1000}
                    alt='wash-fold'
                  />
              ...
              <div className='col-span-2 xl:col-span-1'>
                <div className='flex justify-start items-center gap-2 sm:gap-5'>
                  <div className='w-8 h-8 sm:w-12 sm:h-12 bg-[#CEF2EF] rounded-full flex justify-center items-center'>
                    <RiShirtLine className='text-[#76A6A6] text-lg sm:text-2xl md:text-4xl leading-none' />
                  </div>
                  <h2 className='text-2xl sm:text-4xl xl:text-5xl font-extrabold leading-none text-black capitalize'>
                    Wash & Fold
                  </h2>
          ...
          <div className='pb-16 px-4 sm:px-8 xl:px-16'>
            <div className='grid grid-cols-1 md:grid-cols-4 xl:grid-cols-3 gap-8 items-center'>
              <div className='col-span-2 xl:col-span-1'>
                <div className='flex justify-start items-center gap-2 sm:gap-5'>
                  <div className='w-8 h-8 sm:w-12 sm:h-12 bg-[#CEF2EF] rounded-full flex justify-center items-center'>
                    <GiSewingMachine className='text-[#76A6A6] text-lg sm:text-2xl md:text-4xl leading-none' />
                  </div>
                  <h2 className='text-2xl sm:text-4xl xl:text-5xl font-extrabold leading-none text-black capitalize'>
                  Cloth Sewing
                  </h2>
                ...
                <div className='flex md:hidden justify-center items-center my-4'>
                  <Image
                    src='/imgs/local-laundry/sewing.jpg'
                    width={1000}
                    height={1000}
                    alt='sewing'
                  />
          ...
          <div className="relative w-full bg-[url('/imgs/local-laundry/delivery.jpg')] bg-no-repeat bg-cover bg-top">
            <div className='w-full py-16 px-4 sm:px-8 xl:px-16 bg-transparent flex justify-start items-center'>
